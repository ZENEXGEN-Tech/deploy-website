...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-32 items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
...
export function ZenexgenTechStack() {
  ...
  return (
    <div
      className="relative flex h-[100vh] w-full items-center justify-center overflow-hidden p-10"
      ref={containerRef}
    >
      <div className="flex size-full max-h-[400px] max-w-lg flex-col items-stretch justify-between gap-8">
        {/* Top row */}
      ...
      {/* Animated beams connecting all technologies to the center OpenAI circle */}
      <AnimatedBeam
